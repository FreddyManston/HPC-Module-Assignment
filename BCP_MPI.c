...
** Date:		October 2018
** Description:	BRUTE FORCE IMPLEMENTATION OF BICHROMATIC CLOSEST-PAIR PROBLEM, USING MPI FOR PARALLEL PROCESSES
*/
...
int main(int argc, char **argv) {
	...
	*/
	...
	/*
		*	Implementing concurrent parallel programming
		*	i.e. simply splitting tasks and running them on different cores
	*/
